    ...
    <PopupState variant="popover">
      {
        ...
        popupState => (
          <div>
            <IconButton {...bindTrigger(popupState)} className={styles.settingsButton}>
              <Settings />
            </IconButton>
            <Popover
...
function SettingsDetails() {
  ...
  const { slippage, setSlippage, fairOverride, setFairOverride } = useSwapContext();
  ...
  return (
    <div style={{ padding: '15px', width: '305px' }}>
      ...
      <OpenOrdersDialog open={showSettingsDialog} onClose={() => setShowSettingsDialog(false)} />
    </div>
  );
}
