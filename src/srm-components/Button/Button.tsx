...
const DoneButton = styled(Button)(({ theme }) => ({
  ...
  maxWidth: "169px",
  color: "#FFFFFF",
  background: "linear-gradient(black, black) padding-box, linear-gradient(266.19deg, #EC26F5 -9.56%, #9F5AE5 102.3%) border-box",
  borderRadius: "17px",
  ...
  textAlign: 'center',
  "&:hover": {
    background: "linear-gradient(250.38deg, #EC26F5 -1.07%, #9F5AE5 92.17%) padding-box, linear-gradient(250.38deg, #EC26F5 -1.07%, #9F5AE5 92.17%) border-box",
    boxShadow: "0px 0px 16px #9F5AE5",
  },
}));
...
const SubscribeButton = styled(Button)(({ theme }) => ({
  ...
  "&:hover": {
    background: "linear-gradient(257.52deg, #0156FF -5.37%, #9F5AE5 84.69%) padding-box, linear-gradient(257.52deg, #0156FF -5.37%, #9F5AE5 84.69%) border-box",
    boxShadow: "0px 0px 16px #9F5AE5",
  },
}));
